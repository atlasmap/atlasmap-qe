...
Feature: Mappings of nested collections
  ...
  Scenario Outline: Asymmetric nested collections support 3rd level to 2nd level
    ...
    Then save and verify asymmetric nested collection from third level <from> to second level json collection as "asymNested<from>leveltoSecondLevelCollection.json"
  ...
  Scenario Outline: Asymmetric nested collections support 2rd level to 3nd level
    ...
    Then save and verify asymmetric nested collection from second level <from> to third level xml collection as "asymNested<from>leveltoSecondLevelCollection.json"
